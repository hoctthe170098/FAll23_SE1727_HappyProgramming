...
<div class="col-12">
<div class="my-5">
<h3>CV of Mentee ${CV.getP().getFullname()}</h3>
<hr>
</div>
...
<div class="square position-relative display-2 mb-3">
   <img style="height: 300px;width: 360px" class="square position-relative display-2 mb-3" src=${CV.getP().getAvatar()} id="image" alt=""/>  
</div>
</div>
</div>
</div>
...
<b>${CV.getP().getFullname()}</b>
</div>
<div class="col-md-6">
<label class="form-label">Phone number :</label>
<b>${CV.getP().getPhone()}</b>
</div>
<div class="col-md-6">
