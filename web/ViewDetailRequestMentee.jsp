...
<html>
    <head>
        ...
        <title>Detail Request Mentee</title>
                            ...
                            <div class="col-12">
                                ...
                                <div class="file-upload">
                                    ...
                                    <c:if test="${r.status=='Processing'}">
                                        <form action="updateordeleterequest?id1=${r.ID}" method="post" enctype="multipart/form-data" name="formdelete" style="display: inline " >
