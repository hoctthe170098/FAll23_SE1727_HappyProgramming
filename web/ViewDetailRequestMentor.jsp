                                    ...
                                    <c:choose>
                                        <c:when test="${r.status=='Processing'}">
                                           <span style="text-align: center">   
                                                <button  class="btn btn-danger btn-lg" onclick="return Action('reject',${r.ID})">Reject</button>
                                                <button  class="btn btn-primary btn-lg" onclick="return Action('accept',${r.ID})">Accept</button>
                                            </span> 
                                        </c:when>
                                                    ...
                                                    function Action(action,ID) {
                                                        swal({
                                                            ...
                                                            dangerMode: true,
                                                                ...
                                                                .then((isOkay) => {
                                                                    if (isOkay) {
                                                                        window.location.href = 'actionrequestmentor?action='+action+'&ID=' + ID;
                                                                    }
                                                                }
                                                                );
                                                        return false;
